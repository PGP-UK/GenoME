...
const allImages = [
  ...
  require('./assets/Individual/Health/heart/stephan_heart_profile.png'),
  require('./assets/Individual/Health/ovarian/stephan_ovarian_profile.png'),
  require('./assets/Individual/Health/crohns/stephan_crohn_profile.png'),
  require('./assets/Individual/Health/heart/colin_heart_profile.png'),
  require('./assets/Individual/Health/ovarian/colin_ovarian_profile.png'),
  require('./assets/Individual/Health/crohns/colin_crohn_profile.png'),
  require('./assets/Individual/Health/heart/laura_heart_profile.png'),
  require('./assets/Individual/Health/ovarian/laura_ovarian_profile.png'),
  require('./assets/Individual/Health/crohns/laura_crohn_profile.png'),
  require('./assets/Individual/Health/heart/momodou_heart_profile.png'),
