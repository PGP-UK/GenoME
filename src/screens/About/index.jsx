...
const About = () => (
  <PageLayout>
    <Section>
      <Block>
        <HeaderRow headerText="About PGP-UK" backBtn />
        <PageText>
          ...
          ways to join the PGP-UK community and keep up-to-date with the project - just follow the links at the bottom of this page.
          {"\n\n"}
        ...
        <PageText style={styles.disclaimer}>
          DISCLAIMER: The generation of genomic data is not an error-free process and our analysis software is under continued development.
...
const WorldImage = () => (
  <FastImage
    ...
    style={[
      { width: useSafeAreaFrame().width - 30, height: useSafeAreaFrame().width * 0.35 },
      styles.image,
    ]}
  />
)
