...
const Iconimage = withSizeInfo(({ sizeSelector, ...props }) => {
  ...
  const imageWidth =
    Math.round(useSafeAreaFrame().width * imagePercentage);
  ...
  return (
    <>
      ...
      <View style={{ alignContent: "center"}}>
        <Lottie ref={lottieRef} source={image} autoPlay loop={false} progress={1}
          style={{ width: finalImageWidth, height: finalImageWidth, alignSelf: "center" }}
