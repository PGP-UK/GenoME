...
const Diseases = (props) => {
  ...
  const {health: { AllAmbassadorsData, diseaseData }, themeColors } = useContext(DataContext)
    ...
    <PageLayout>
      ...
      <Block>
        <PageText category="p1">
          {diseaseInfo.infoHeader}
        </PageText>
      </Block>

      <Grid>
        <Section style={styles.container}>
          <MiddleSection disease={disease} data={data} name={name} image={image}/>
        </Section>
      </Grid>
